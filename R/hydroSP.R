#####################################################################
#             'lib_Spatial_for_HydrologicalModelling'               #
#####################################################################
#  Library for Time Series Analysis in Hydrological Modelling       #
...
# Dependencies: gstat, automap, maptools, sp, lattice

########################################################################
# Included functions:
# 01) northarrow  : Nice North Arrow, from JSS Volume 19, Code Snippet 1.
# 02) scalebar    : Nice Scale bar, from JSS Volume 19, Code Snippet 1.
# 03) hydrokrige  : (Block) IDW, OK, KED Interpolation over catchments, with optional plot
# 04) gists2spt   : Time Series and GIS to Spatio-temporal Object 



############################################
#       northarrow: Nice North Arrow       #
############################################
# Taken from Tanimura, Kuroiwa and Mizota, #
# in the JSS Volume 19, Code Snippet 1     #
# http://www.jstatsoft.org/v19/c01/paper   #
############################################
#     April 23th, 2009                     #
############################################
# 'loc'     : Location of its center position
# 'size'    : Size of the north arrow. The default
# 'bearing' : for the angle (in degrees) of the north arrow,
#             in accordance with the orientation of the map
...
############################################
# 'loc'     : Location of its center position
# 'length'  : Size of the north arrow. The default
# 'unit   ' : for the angle (in degrees) of the north arrow,
#             in accordance with the orientation of the map
